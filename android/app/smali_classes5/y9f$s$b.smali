...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ly9f$s$b;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Ly9f$s$b;->g:Ljava/lang/Object;
    ...
    iput-object v1, p0, Ly9f$s$b;->k:Lw9f;

    iput-object v0, p0, Ly9f$s$b;->l:Ljava/lang/Object;
...
.method public constructor <init>(Lhaf$c;Ly9f$a;)V
    ...
    iput-object p1, p0, Ly9f$s$b;->e:Ljava/util/List;
    ...
    iput-object p1, p0, Ly9f$s$b;->g:Ljava/lang/Object;

    const/4 v0, 0x6

    sget-object p2, Lw9f;->b:Lw9f;

    const/4 v0, 0x1

    iput-object p2, p0, Ly9f$s$b;->k:Lw9f;

    const/4 v0, 0x2

    iput-object p1, p0, Ly9f$s$b;->l:Ljava/lang/Object;
...
.method public constructor <init>(Ly9f$a;)V
    ...
    iput-object v0, p0, Ly9f$s$b;->k:Lw9f;
...
.method public bridge synthetic A(Lx9f;Leaf;)Lq9f$a;
    ...
    invoke-virtual {p0, p1, p2}, Ly9f$s$b;->U(Lx9f;Leaf;)Ly9f$s$b;
...
.method public B(Lpaf;)Lq9f$a;
    ...
    invoke-virtual {p0, p1}, Ly9f$s$b;->V(Ly9f$s;)Ly9f$s$b;
...
.method public D(Lcom/google/protobuf/Descriptors$f;Ljava/lang/Object;)Lpaf$a;
    ...
    invoke-virtual {p0}, Ly9f$s$b;->J()Lhaf$f;
...
.method public bridge synthetic G()Lhaf$b;
    ...
    invoke-virtual {p0}, Ly9f$s$b;->T()Ly9f$s$b;
...
.method public bridge synthetic O()Lpaf;
    ...
    invoke-virtual {p0}, Ly9f$s$b;->S()Ly9f$s;
...
.method public S()Ly9f$s;
    ...
    invoke-direct {v0, p0, v1}, Ly9f$s;-><init>(Lhaf$b;Ly9f$a;)V

    const/4 v6, 0x7

    iget v1, p0, Ly9f$s$b;->d:I

    const/4 v6, 0x1

    iget-object v2, p0, Ly9f$s$b;->f:Labf;
    ...
    iget-object v2, p0, Ly9f$s$b;->e:Ljava/util/List;
    ...
    iput-object v2, p0, Ly9f$s$b;->e:Ljava/util/List;

    const/4 v6, 0x1

    iget v2, p0, Ly9f$s$b;->d:I
    ...
    iput-object v2, v0, Ly9f$s;->e:Ljava/util/List;
    ...
    iget-object v2, p0, Ly9f$s$b;->g:Ljava/lang/Object;

    const/4 v6, 0x7

    iput-object v2, v0, Ly9f$s;->f:Ljava/lang/Object;
    ...
    iget-wide v4, p0, Ly9f$s$b;->h:J

    const/4 v6, 0x5

    iput-wide v4, v0, Ly9f$s;->g:J
    ...
    iget-wide v4, p0, Ly9f$s$b;->i:J

    const/4 v6, 0x3

    iput-wide v4, v0, Ly9f$s;->h:J
    ...
    iget-wide v4, p0, Ly9f$s$b;->j:D

    const/4 v6, 0x5

    iput-wide v4, v0, Ly9f$s;->i:D
    ...
    iget-object v2, p0, Ly9f$s$b;->k:Lw9f;

    const/4 v6, 0x0

    iput-object v2, v0, Ly9f$s;->j:Lw9f;
    ...
    iget-object v1, p0, Ly9f$s$b;->l:Ljava/lang/Object;

    const/4 v6, 0x2

    iput-object v1, v0, Ly9f$s;->k:Ljava/lang/Object;

    const/4 v6, 0x3

    iput v3, v0, Ly9f$s;->d:I
...
.method public U(Lx9f;Leaf;)Ly9f$s$b;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0}, Ly9f$s$b;->V(Ly9f$s;)Ly9f$s$b;
...
.method public V(Ly9f$s;)Ly9f$s$b;
    .locals 4
    ...
    iget-object v0, p0, Ly9f$s$b;->f:Labf;

    if-nez v0, :cond_3

    const/4 v3, 0x3

    iget-object v0, p1, Ly9f$s;->e:Ljava/util/List;
    ...
    iget-object v0, p0, Ly9f$s$b;->e:Ljava/util/List;
    ...
    iget v0, p0, Ly9f$s$b;->d:I

    and-int/lit8 v0, v0, -0x2

    iput v0, p0, Ly9f$s$b;->d:I
    ...
    iget-object v1, p1, Ly9f$s;->e:Ljava/util/List;
    ...
    iput-object v1, p0, Ly9f$s$b;->f:Labf;
    ...
    iget-object v0, p1, Ly9f$s;->f:Ljava/lang/Object;
    ...
    iget-object v0, p1, Ly9f$s;->j:Lw9f;
    ...
    iget-object v0, p1, Ly9f$s;->k:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ly9f$s$b;->W(Libf;)Ly9f$s$b;
...
.method public final W(Libf;)Ly9f$s$b;
    .locals 1
...
.method public bridge synthetic build()Lpaf;
    ...
    invoke-virtual {p0}, Ly9f$s$b;->build()Ly9f$s;
