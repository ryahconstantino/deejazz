...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ly9f$q$b;->g:Ljava/util/List;
...
.method public constructor <init>(Lhaf$c;Ly9f$a;)V
    ...
    iput-object p1, p0, Ly9f$q$b;->g:Ljava/util/List;
...
.method public bridge synthetic A(Lx9f;Leaf;)Lq9f$a;
    ...
    invoke-virtual {p0, p1, p2}, Ly9f$q$b;->Z(Lx9f;Leaf;)Ly9f$q$b;
...
.method public B(Lpaf;)Lq9f$a;
    ...
    instance-of v0, p1, Ly9f$q;

    const/4 v1, 0x4

    if-eqz v0, :cond_0

    check-cast p1, Ly9f$q;

    const/4 v1, 0x1

    invoke-virtual {p0, p1}, Ly9f$q$b;->a0(Ly9f$q;)Ly9f$q$b;
...
.method public bridge synthetic G()Lhaf$b;
    ...
    invoke-virtual {p0}, Ly9f$q$b;->Y()Ly9f$q$b;
...
.method public J()Lhaf$f;
    ...
    const-class v1, Ly9f$q;

    const-class v1, Ly9f$q;

    const/4 v3, 0x2

    const-class v2, Ly9f$q$b;
...
.method public bridge synthetic O()Lpaf;
    ...
    invoke-virtual {p0}, Ly9f$q$b;->X()Ly9f$q;
...
.method public X()Ly9f$q;
    ...
    invoke-direct {v0, p0, v1}, Ly9f$q;-><init>(Lhaf$d;Ly9f$a;)V

    const/4 v4, 0x2

    iget v1, p0, Ly9f$q$b;->e:I
    ...
    iget-boolean v2, p0, Ly9f$q$b;->f:Z

    const/4 v4, 0x5

    iput-boolean v2, v0, Ly9f$q;->f:Z

    const/4 v4, 0x7

    iget-object v2, p0, Ly9f$q$b;->h:Labf;
    ...
    iget-object v1, p0, Ly9f$q$b;->g:Ljava/util/List;
    ...
    iput-object v1, p0, Ly9f$q$b;->g:Ljava/util/List;
    ...
    iput-object v1, v0, Ly9f$q;->g:Ljava/util/List;
...
.method public Z(Lx9f;Leaf;)Ly9f$q$b;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0}, Ly9f$q$b;->a0(Ly9f$q;)Ly9f$q$b;
...
.method public a0(Ly9f$q;)Ly9f$q$b;
    .locals 4
    ...
    iput-boolean v0, p0, Ly9f$q$b;->f:Z
    ...
    iget-object v0, p0, Ly9f$q$b;->h:Labf;
    ...
    iget-object v0, p1, Ly9f$q;->g:Ljava/util/List;
    ...
    iget-object v0, p0, Ly9f$q$b;->g:Ljava/util/List;
    ...
    iget v0, p0, Ly9f$q$b;->e:I

    const/4 v3, 0x2

    and-int/lit8 v0, v0, -0x3

    iput v0, p0, Ly9f$q$b;->e:I
    ...
    iget-object v2, p0, Ly9f$q$b;->g:Ljava/util/List;
    ...
    iget-object v1, p1, Ly9f$q;->g:Ljava/util/List;
    ...
    iput-object v1, p0, Ly9f$q$b;->h:Labf;
    ...
    invoke-virtual {p0, p1}, Ly9f$q$b;->b0(Libf;)Ly9f$q$b;
...
.method public final b0(Libf;)Ly9f$q$b;
    .locals 1
...
.method public bridge synthetic build()Lpaf;
    ...
    invoke-virtual {p0}, Ly9f$q$b;->build()Ly9f$q;
