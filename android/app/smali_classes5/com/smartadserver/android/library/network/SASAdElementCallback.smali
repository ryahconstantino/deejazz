.class public Lcom/smartadserver/android/library/network/SASAdElementCallback;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "SASAdElementCallback"
...
.method public constructor <init>(Landroid/content/Context;Lcom/smartadserver/android/library/ui/SASAdView$AdResponseHandler;JLcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;Lcom/smartadserver/android/library/model/SASFormatType;)V
    ...
    iput-object p1, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->context:Landroid/content/Context;

    iput-object p2, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->handler:Lcom/smartadserver/android/library/ui/SASAdView$AdResponseHandler;

    const/4 v0, 0x0

    iput-wide p3, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->expirationTime:J

    const/4 v0, 0x4

    iput-object p5, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->remoteLoggerManager:Lcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;

    const/4 v0, 0x2

    iput-object p6, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->expectedFormatType:Lcom/smartadserver/android/library/model/SASFormatType;
...
.method private onFailureManagement(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->handler:Lcom/smartadserver/android/library/ui/SASAdView$AdResponseHandler;
...
.method public onFailure(Lm3i;Ljava/io/IOException;)V
    ...
    iget-object p1, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->remoteLoggerManager:Lcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;
    ...
    invoke-direct {p0, p2}, Lcom/smartadserver/android/library/network/SASAdElementCallback;->onFailureManagement(Ljava/lang/Exception;)V
...
.method public onResponse(Lm3i;Ls4i;)V
    ...
    iget-wide v1, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->expirationTime:J
    ...
    sget-object v4, Lcom/smartadserver/android/library/network/SASAdElementCallback;->TAG:Ljava/lang/String;
    ...
    const-string v6, "Tngmirn:emiaem"
    ...
    iget-object v3, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->remoteLoggerManager:Lcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;

    const/4 v9, 0x0

    iget-object v4, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->expectedFormatType:Lcom/smartadserver/android/library/model/SASFormatType;
    ...
    const-string v4, "A wepbnlutiee s lr dda:cohc esecd"
    ...
    iget-object v2, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->handler:Lcom/smartadserver/android/library/ui/SASAdView$AdResponseHandler;
    ...
    const-string v2, "imd e unooeeeaeldellagieerrtnlarhe rsPnonti pdaptdtcashhqo  (cak m ei.atihs mnTuce rm eeheaeoo   .e tsit m sor  h)A pd gadtdtaegean r cnvntahnema afer  ht"

    const-string v2, "There is no ad to deliver on this placement. Please check tha ad request parameters (in the loadAd method) and the ad programming on the manage interface."
    ...
    iget-object v1, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->remoteLoggerManager:Lcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;
    ...
    iget-object v1, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->handler:Lcom/smartadserver/android/library/ui/SASAdView$AdResponseHandler;
    ...
    iget-object v2, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->remoteLoggerManager:Lcom/smartadserver/android/library/components/remotelogger/SASRemoteLoggerManager;
    ...
    invoke-direct {p0, p1}, Lcom/smartadserver/android/library/network/SASAdElementCallback;->onFailureManagement(Ljava/lang/Exception;)V
    ...
    iget-object v3, p0, Lcom/smartadserver/android/library/network/SASAdElementCallback;->expectedFormatType:Lcom/smartadserver/android/library/model/SASFormatType;
    ...
    const-string v2, "An error occurred when parsing JSON ad content. "
    ...
    invoke-direct {p0, v7}, Lcom/smartadserver/android/library/network/SASAdElementCallback;->onFailureManagement(Ljava/lang/Exception;)V
