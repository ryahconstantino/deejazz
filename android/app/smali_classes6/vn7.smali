...
.method public constructor <init>(Lcm;)V
    ...
    invoke-direct {v0, p0, p1}, Lvn7$a;-><init>(Lvn7;Lcm;)V

    const/4 v1, 0x6

    iput-object v0, p0, Lvn7;->b:Lyl;

    const/4 v1, 0x4

    new-instance v0, Lvn7$b;

    invoke-direct {v0, p0, p1}, Lvn7$b;-><init>(Lvn7;Lcm;)V

    const/4 v1, 0x5

    iput-object v0, p0, Lvn7;->c:Lhm;
...
.method public a()Lbag;
    ...
    const-string v0, "SELECT * FROM entrypoints"
    ...
    new-instance v1, Lvn7$c;

    const/4 v2, 0x7

    invoke-direct {v1, p0, v0}, Lvn7$c;-><init>(Lvn7;Lem;)V
