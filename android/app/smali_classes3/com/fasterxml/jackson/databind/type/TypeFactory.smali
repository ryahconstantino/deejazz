...
.method public _fromAny(Lcom/fasterxml/jackson/databind/type/ClassStack;Ljava/lang/reflect/Type;Lcom/fasterxml/jackson/databind/type/TypeBindings;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string p2, "ris i/Nalpnbadeusadebls( g tinplys` ` v/"
    ...
    invoke-static {p2, v0, p3}, Loy;->z0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string p3, "ncrmg:UeypeoTizd n "
...
.method public _fromClass(Lcom/fasterxml/jackson/databind/type/ClassStack;Ljava/lang/Class;Lcom/fasterxml/jackson/databind/type/TypeBindings;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string v2, "iet obtye aratnm nmscrtne:rpdea ee"
    ...
    const-string v3, "tge Mnuap typ rea"
    ...
    invoke-static {v11, v3, v2}, Loy;->k0(Ljava/lang/Class;Ljava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "ytltocSpneriCgnotp ee a "
    ...
    const-string v3, "fgeteeenqnert aype  rRc"
    ...
    const-string v4, "r stT=e snl -rrvorla;ineteosfcee  ed efgyul  "
...
.method public constructCollectionType(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/type/CollectionType;
    ...
    const-string p1, "dsscoecb%ttoeotoei orwineitslls tiNnghor%lt snsm   h%etpe odul mniotesC ylnen e-  age  c "
    ...
    const-string v0, "  ygnbolCfna orBsieedsTitcrpstac an n"
    ...
    const-string p1, "sa thtuaesam p   : xsc1ipelecwyrptet e"
...
.method public constructFromCanonical(Ljava/lang/String;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string p1, "keenUemp eetftpolxept sdn rtceatyoec "
...
.method public constructGeneralizedType(Lcom/fasterxml/jackson/databind/JavaType;Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string p1, " %ly%ssnqsp fr suae -Coato tpse"
    ...
    const-string p1, "s-ssc It oncnio peoer:sp d%srsdnr%yeeaaferunrl u ll arst t"
...
.method public constructMapType(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/type/MapType;
    ...
    const-string p3, "Carm ngoco e itysslcnipan dnfrBeasetT"
    ...
    const-string v0, "  thoi"

    const-string v0, " with "

    const/4 v10, 0x1

    invoke-static {p1, p3, v0}, Loy;->j(Ljava/lang/Class;Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    const-string p1, "ea mtbaryrte ep"
    ...
    const-string p1, " elpxsuc ec: ssa"
    ...
    const-string p1, " vt  o pdsiiaoMoibrsse pedu-ys%ta t geths lslpmNecinwaeo rnlsuet ctg nv h%e  n %"
    ...
    const-string p1, "osaslbetqnhd u%ovedct%ss ageNhsyostntiitopn   it e  g%rw emoy eiMr  npl es-kc "
...
.method public constructSpecializedType(Lcom/fasterxml/jackson/databind/JavaType;Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    new-instance v7, Lcom/fasterxml/jackson/databind/type/PlaceholderForType;

    invoke-direct {v7, v6}, Lcom/fasterxml/jackson/databind/type/PlaceholderForType;-><init>(I)V
    ...
    :cond_9
    invoke-static {p2, v3}, Lcom/fasterxml/jackson/databind/type/TypeBindings;->create(Ljava/lang/Class;[Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/type/TypeBindings;

    move-result-object v6

    invoke-virtual {p0, v2, p2, v6}, Lcom/fasterxml/jackson/databind/type/TypeFactory;->_fromClass(Lcom/fasterxml/jackson/databind/type/ClassStack;Ljava/lang/Class;Lcom/fasterxml/jackson/databind/type/TypeBindings;)Lcom/fasterxml/jackson/databind/JavaType;

    move-result-object v2

    iget-object v6, p1, Lcom/fasterxml/jackson/databind/JavaType;->_class:Ljava/lang/Class;
    ...
    invoke-virtual {v6}, Lcom/fasterxml/jackson/databind/type/TypeBindings;->getTypeParameters()Ljava/util/List;
    ...
    :goto_3
    invoke-virtual {p0, v10, v11}, Lcom/fasterxml/jackson/databind/type/TypeFactory;->_verifyAndResolvePlaceholders(Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/JavaType;)Z

    move-result v12

    if-nez v12, :cond_10

    iget-object v12, v10, Lcom/fasterxml/jackson/databind/JavaType;->_class:Ljava/lang/Class;
    ...
    iget-object v12, v11, Lcom/fasterxml/jackson/databind/JavaType;->_class:Ljava/lang/Class;
    ...
    :cond_e
    invoke-virtual {v10}, Lcom/fasterxml/jackson/databind/JavaType;->isInterface()Z
    ...
    invoke-virtual {v10, v12}, Lcom/fasterxml/jackson/databind/JavaType;->isTypeOrSuperTypeOf(Ljava/lang/Class;)Z
    ...
    invoke-virtual {v10}, Lcom/fasterxml/jackson/core/type/ResolvedType;->toCanonical()Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lcom/fasterxml/jackson/core/type/ResolvedType;->toCanonical()Ljava/lang/String;

    move-result-object v5

    aput-object v5, v0, v2

    const-string v2, "pds%sti hatipie%fsa% fm  yreTeeeaia drccwds ;sznp n %#tol/ r"
    ...
    iget-object v2, v2, Lcom/fasterxml/jackson/databind/type/PlaceholderForType;->_actualType:Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string v2, "td meetbayez i ec eolpiasap Fil"
    ...
    const-string p1, "nemu)beteyaryssoIorb(opopn% l%etfsses :lrt  aur opr nelrr t eeaed lutcb "
    ...
    const-string p1, " tl nsuefab%osps osCsy  t%"
...
.method public constructType(Lcom/fasterxml/jackson/core/type/TypeReference;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    iget-object p1, p1, Lcom/fasterxml/jackson/core/type/TypeReference;->_type:Ljava/lang/reflect/Type;
