...
.field private mRemoteUserInfo:Lzh;
...
.field private mVolumeCallback:Lci$d;

.field public mVolumeProvider:Lci;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lcp;Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lci$d;
    ...
    invoke-direct {p2, p1, p3, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lcp;)V
    ...
    const-string p2, "vlameRneomc tboeon tmdc tneBnetneur uoMayl pi"
...
.method public adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lci;
    ...
    iget-object v0, p2, Lsj;->g:Lpj$e$d;
    ...
    iget-object v0, v0, Lpj$e;->k:Lpj$e$c;
    ...
    invoke-direct {v1, p2, p1}, Lrj;-><init>(Lsj;I)V
...
.method public buildRccMetadata(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    const-string v2, "daido.mr.eoTmiad.eanatadAt"
    ...
    const-string v2, "ediBdbUMdaamm.aeor.atLi.anAt"
    ...
    const-string v1, "idaBaMuSrdATamR._.LeiT.meIndottAaUa"
    ...
    const-string v1, "aatSdddpaTdmmiIa.oTtrin.eReAa"
    ...
    const-string v1, "aotOHmrTqmd.Uieae.dtadaAid.Ra"
    ...
    const-string v1, "d.sOIama.Mdn.AIdotdmatPiiaOeCaLreN"
    ...
    const-string v1, "SdamOd.OronaaCaaiMtPe.mEmtRdde."
    ...
    const-string v1, "tTEAoaanDama.edei.drta.moid"
    ...
    const-string v1, "EdtrBbUnaimeiaaI_CMD.otRNae..maddS"
    ...
    const-string v1, "atdedruEa.aNanadimGmto.EiRd."
    ...
    const-string v1, "idd.Lampt.eaTnmdataaIoTEed.r"
    ...
    const-string v1, ".rC.dNmMqaaEdaURoBeiaAeR_TtidKatnm."
    ...
    const-string v1, "TtsnWI..roiaaReaiRammteddddE."
...
.method public getCurrentControllerInfo()Lzh;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lzh;
...
.method public getPackageNameForUid(I)Ljava/lang/String;
    ...
    const-string p1, "ldemond.asealoionirdenre.os.trMsiimaC"
...
.method public postToHandler(IIILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    const-string p4, "dngiol_lctaiuaad"
    ...
    const-string p4, "ktlggbad_nalp_ic"
    ...
    const-string p4, "ca_d_puidgtaalln"
    ...
    const-string p3, "dp_iildpta_alnca"
...
.method public setCurrentControllerInfo(Lzh;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lzh;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lci;
...
.method public setPlaybackToRemote(Lci;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lci;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lci;
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lci$d;

    const/4 v7, 0x7

    iput-object v0, p1, Lci;->e:Lci$d;
    ...
    const-string v0, " rsm dmltyrnvlou lPoabneviuoee"
...
.method public setVolumeTo(II)V
    ...
    invoke-direct {v1, p2, p1}, Lqj;-><init>(Lsj;I)V
