...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    const-string v5, "ajsotAboinmrec"
    ...
    invoke-static/range {v0 .. v6}, Lvo;->e(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    ...
    sget-object v0, Lto;->h:[I

    move-object/from16 v7, p4

    invoke-static {v8, v9, v7, v0}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v6

    const-string v0, "gndeoior"

    const-string v0, "ordering"

    invoke-static {v10, v0}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static/range {v0 .. v7}, Lvo;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    :cond_5
    const-string v5, "oHeerblestaVopudyrrl"
    ...
    sget-object v3, Lto;->i:[I

    invoke-static {v8, v9, v1, v3}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    const-string v7, "epNrtyueromp"

    const-string v7, "propertyName"

    invoke-static {v3, v10, v7, v2}, La0$e;->K(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v7

    const-string v14, "uaeeyvTpp"

    const-string v14, "valueType"

    invoke-static {v10, v14}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v9, v1, v4}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v1

    invoke-static {v10, v2}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v9, v5, v4}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v10, v4}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v5, v8}, Lvo;->b(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    :cond_1f
    invoke-static {v4, v8}, Lvo;->b(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    invoke-static {v3, v15, v1, v14, v7}, Lvo;->c(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    const-string v1, "taano rwnn keoom :Uainm"
...
.method public static c(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-static {p1}, La0$e;->r(Ljava/lang/String;)[Ln8;
    ...
    const-string p3, "fro rb/nah mp/mC ot"
    ...
    invoke-static {p3, p1, p4, p0}, Loy;->B0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    ...
    sget-object v4, Lto;->g:[I

    invoke-static {v0, v1, v2, v4}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v4

    sget-object v5, Lto;->k:[I

    invoke-static {v0, v1, v2, v5}, La0$e;->e0(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    :goto_0
    const-string v2, "nuiaodut"

    const-string v2, "duration"

    invoke-static {v3, v2}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    const-string/jumbo v12, "yluavpTeq"

    const-string v12, "valueType"

    invoke-static {v3, v12}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v4, v2, v15, v12, v5}, Lvo;->c(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-static {v0, v3, v5, v6}, La0$e;->K(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v5

    if-eqz v5, :cond_18

    const-string v7, "eepXtruamyorp"

    const-string v7, "propertyXName"

    const/4 v8, 0x2

    invoke-static {v0, v3, v7, v8}, La0$e;->K(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v7

    const-string v8, "eyeamNYpprrto"

    const-string v8, "propertyYName"

    invoke-static {v0, v3, v8, v14}, La0$e;->K(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    const-string v0, "eee iYetqyp nameoaaNtPradpo  erph Notmea f podrrrystDX"
    ...
    :cond_10
    :goto_b
    invoke-static {v5}, La0$e;->s(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-static {v0, v3, v1, v9}, La0$e;->K(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_e
    const-string v1, "rosntrlaopte"

    const-string v1, "interpolator"

    invoke-static {v3, v1}, La0$e;->U(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
